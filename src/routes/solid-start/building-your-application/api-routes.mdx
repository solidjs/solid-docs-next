...
An API route is expected to return JSON or a `Response` object. To handle all methods, you should define a handler function and bind multiple methods to it, like so:
